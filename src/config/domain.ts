const development_domain = "https://aleppo-reconsruction-5th.runasp.net";
const production_domain = "https://aleppo-reconsruction-5th.runasp.net";
...
const SERVER_URL =
  process.env.NODE_ENV === "development"
    ? development_domain_api
    : production_domain_api;
