  ...
  return (
    <div className="flex min-h-screen md:p-0 bg-primary">
      <div className="flex overflow-hidden flex-1">
        ...
        {/* Right: Form */}
        <div className="flex flex-col justify-center items-center p-4 pt-0 md:p-8 w-full md:w-auto overflow-hidden bg-white flex-1 border-y-20 lg:border-none  border-primary">
          {title && subTitle && (
            <div className="self-start px-4 md:px-8">
